...
>
    ...
    <form
        ...
        method="POST"
        action="{{ route('custom-styles.update', $customStyle) }}"
    ...
    >
        ...
        @php
            ...
            $tokenInputs .= view('components.style.token-input', [
                'name' => 'primary',
                'label' => 'Primary color',
                'type' => 'color',
                'value' => old('tokens.primary', $tokens['primary'] ?? '#6366f1'),
            ])->render();
            ...
            $tokenInputs .= view('components.style.token-input', [
                ...
                'type' => 'color',
                'value' => old('tokens.secondary', $tokens['secondary'] ?? '#22c55e'),
            ])->render();
            ...
            $tokenInputs .= view('components.style.token-input', [
                ...
                'type' => 'color',
                'value' => old('tokens.background', $tokens['background'] ?? '#ffffff'),
            ])->render();
            ...
            $tokenInputs .= view('components.style.token-input', [
                ...
                'type' => 'color',
                'value' => old('tokens.card', $tokens['card'] ?? '#f9fafb'),
            ])->render();
            ...
            $tokenInputs .= view('components.style.token-input', [
                ...
                'type' => 'text',
                'placeholder' => '12px',
                'value' => old('tokens.radius', $tokens['radius'] ?? '12px'),
            ])->render();
        @endphp
        ...
        <div data-style-editor="custom-css">
            ...
            >{{ old('custom_css', $customStyle->custom_css) }}</textarea>
        </div>
